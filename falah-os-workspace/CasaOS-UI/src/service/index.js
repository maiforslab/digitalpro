...
// appManagement.appStore = new iStoreMethodsApiFactory(config, '/v2/app_management', instance);
appManagement.appStore = new iStoreMethodsApi(config, '/v2/app_management', instance);
