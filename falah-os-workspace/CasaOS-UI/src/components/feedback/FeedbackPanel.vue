		...
		<footer class="modal-card-foot is-flex is-align-items-center ">
			<div class="is-flex-grow-1">
				<a class="is-size-14px" rel="noopener"
				   href="https://github.com/IceWhaleTech/Falah OS/issues/new/choose"
				   target="_blank">{{ $t('For more feedback options, visit Falah OS project on GitHub...') }}</a>
			</div>
			<div>
...
export default {
	...
	methods: {
		submitIssue() {
			...
			let repoUrl = new URL(`https://github.com/IceWhaleTech/Falah OS/issues/new`);
