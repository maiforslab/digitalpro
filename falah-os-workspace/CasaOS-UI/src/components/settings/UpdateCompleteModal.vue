		...
		<section class="modal-card-body ">
			<div class="node-card  mt-5 mb-5">
				...
				<div class="mt-2rem">
					...
					<div class=" is-size-14px">{{ $t('Please share to friends who are concerned about family and data privacy to join and use Falah OS.') }}
					</div>
				</div>
...
export default {
	...
	data() {
		return {
			...
			updateTimer: 0,
			markdown: ``,
			githubUrl: `https://github.com/IceWhaleTech/Falah OS`,
