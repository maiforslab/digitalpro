...
export default {
  ...
  methods: {
    ...
    addTitleToYaml(yaml) {
      ...
      if (yamlObj['x-falahos'] !== undefined)
        return yaml
      ...
      yamlObj['x-falahos'] = {}
      yamlObj['x-falahos'].title = {}
      yamlObj['x-falahos'].title.en_us = serviceName
      yamlObj['x-falahos'].icon = `https://icon.falahos.io/main/all/${serviceName}.png`
      return stringify(yamlObj)
    },
