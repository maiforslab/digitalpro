  ...
  methods: {
    ...
    rssConfirm() {
      ...
      this.$buefy.dialog.confirm({
        title: this.$t('Show news feed from Falah OS Blog'),
        message: this.$t(
          'Falah OS dashboard will get the the latest news feed of https://blog.falahos.io via Internet, which might leave your visit records to the site. Do you accept?',
        ),
        type: 'is-dark',
...
<template>
  <div class="navbar top-bar is-flex is-align-items-center _fixed-height">
        ...
        <b-dropdown-item :focusable="false" aria-role="menu-item" class="p-0" custom>
          ...
          >
            <div class="is-flex is-align-items-center is-flex-grow-1 _is-normal">
              ...
              {{ $t("Show news feed from Falah OS Blog") }}
            </div>
            <div>
              <b-field>
                <b-switch
    ...
    <div class="navbar-menu">
      <div class="navbar-end mr-3 is-flex is-align-items-center">
        <!-- Falah OS Community branding badge -->
        <span class="falah-topbar-badge mr-3">
          <span class="falah-topbar-dot"></span>
          FALAH OS Community
        </span>
      </div>
    </div>
...
.falah-topbar-badge {
	...
	.falah-topbar-dot {
		...
		animation: falah-pulse 2s ease-in-out infinite;
	}
}

@keyframes falah-pulse {
...
.top-bar {
	...
	z-index: 20;
	height: 2.75rem;
	// Falah OS: dark sovereign top bar by default
