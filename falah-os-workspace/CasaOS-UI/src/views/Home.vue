...
export default {
  ...
  methods: {
    ...
    /**
     * @description: Get Falah OS Configs
     * @param {*}
     * @return {*}
     */
    async getConfig() {
    ...
    rssConfirm() {
      this.$buefy.dialog.confirm({
        ...
        message: this.$t('Falah OS dashboard will get the the latest news feed of https://blog.falahos.io via Internet, which might leave your visit records to the site. Do you accept?'),
        type: 'is-dark',
