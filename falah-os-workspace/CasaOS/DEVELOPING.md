# Falah OS Development
Here we will describe the steps required to setup a development environment with Falah OS.  
...
3. Clone down the repo with the following: `git clone --recurse-submodules --remote-submodules https://github.com/<your GitHub Username>/Falah OS.git`  
