...
import (
	...
	"github.com/IceWhaleTech/Falah OS/pkg/utils/version"
...
func GetSystemCheckVersion(ctx echo.Context) error {
	...
	if need {
		...
		installLog.Name = "Falah OS System"
...
func GetFalahOSErrorLogs(ctx echo.Context) error {
	line, _ := strconv.Atoi(utils.DefaultQuery(ctx, "line", "100"))
	return ctx.JSON(common_err.SUCCESS, model.Result{Success: common_err.SUCCESS, Message: common_err.GetMsg(common_err.SUCCESS), Data: service.MyService.System().GetFalahOSLogs(line)})
}
...
// @Summary get falahos server port
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
// @Success 200 {string} string "ok"
// @Router /sys/port [get]
func GetFalahOSPort(ctx echo.Context) error {
...
// @Summary edit falahos server port
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
...
// @Success 200 {string} string "ok"
// @Router /sys/port [put]
func PutFalahOSPort(ctx echo.Context) error {
...
// @Summary active killing falahos
// @Produce  application/json
// @Accept application/json
// @Tags sys
// @Security ApiKeyAuth
