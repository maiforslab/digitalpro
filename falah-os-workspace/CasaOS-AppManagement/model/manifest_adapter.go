...
func (c *CustomizationPostData) ComposeAppStoreInfo() codegen.ComposeAppStoreInfo {
	...
	message := "This is a compose app converted from a legacy app (Falah OS v0.4.3 or earlier)"

	return codegen.ComposeAppStoreInfo{
		Architectures: &[]string{runtime.GOARCH},
		Author:        "Falah OS User",
		Category:      "unknown",
	...
	return types.Services{
		{
			...
			Extensions: map[string]interface{}{
				common.ComposeExtensionNameXFalahOS: c.AppStoreInfo(),
			},
		},
	}
}
...
func (c *CustomizationPostData) Compose() codegen.ComposeApp {
	return codegen.ComposeApp{
		...
		Services: c.Services(),
		Extensions: map[string]interface{}{
			common.ComposeExtensionNameXFalahOS: c.ComposeAppStoreInfo(),
		},
	}
}
