...
func TestSkipUpdateCatalog(t *testing.T) {
	...
	appStoreURL := []string{
		"https://falahos.app/store/main.zip",
		"https://falahos.oss-cn-shanghai.aliyuncs.com/store/main.zip",
	}
...
func TestWorkDir(t *testing.T) {
	...
	// test for github
	hostname := "github.com"
	path := "/IceWhaleTech/Falah OS-AppStore/archive/refs/heads/main.zip"
...
func TestStoreRoot(t *testing.T) {
	...
	expectedStoreRoot := filepath.Join(workdir, "github.com", "IceWhaleTech", "Falah OS-AppStore", "main")
