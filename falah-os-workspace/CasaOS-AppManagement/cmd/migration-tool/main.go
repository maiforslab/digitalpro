...
const (
	appManagementConfigDirPath  = "/etc/falahos"
	appManagementConfigFilePath = "/etc/falahos/app-management.conf"
	appManagementName           = "falahos-app-management.service"
	appManagementNameShort      = "app-management"
)

//go:embedded ../../build/sysroot/etc/falahos/app-management.conf.sample
