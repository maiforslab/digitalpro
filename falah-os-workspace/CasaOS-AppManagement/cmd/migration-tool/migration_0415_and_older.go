...
var replaceUrl = []UrlReplacement{
	{
		...
		NewUrl: "https://api.falah-consultancy.ltd/istore/apps.json",
	},
	{
		OldUrl: "https://falahos.oss-cn-shanghai.aliyuncs.com/IceWhaleTech/_appstore/archive/refs/heads/main.zip",
		NewUrl: "https://api.falah-consultancy.ltd/istore/apps.json",
	},
	{
		OldUrl: "https://falahos.app/store/main.zip",
		NewUrl: "https://api.falah-consultancy.ltd/istore/apps.json",
	},
}
...
func (u *migrationTool0415AndOlder) IsMigrationNeeded() (bool, error) {
	...
	for _, v := range replaceUrl {
		if strings.Contains(string(content), v.OldUrl) {
			_logger.Info("Migration is needed for a Falah OS with old app store link.")
			return true, nil
		}
	}
	return false, nil
...
func (u *migrationTool0415AndOlder) Migrate() error {
	...
	// replace https://github.com/IceWhaleTech/_appstore/archive/refs/heads/main.zip to https://falahos-appstore.github.io/falahos-appstore/linux-all-appstore.zip
